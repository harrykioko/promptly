  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to Promptly!",
      });
    }, 1500);
  };
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-3">
            Welcome to <GradientText>Promptly</GradientText>
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-xs text-promptly-blue hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
        ...
        <div className="text-center text-sm">
          ...
          <Link to="/signup" className="font-medium text-promptly-blue hover:underline">
            Sign up
          </Link>
        </div>
      </div>
